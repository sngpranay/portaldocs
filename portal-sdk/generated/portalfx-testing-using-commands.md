...
<a name="testing-commands-to-use-commands-from-the-command-bar"></a>
...
<a name="testing-commands-to-use-commands-from-context-menus"></a>
...
<a name="testing-commands-full-example"></a>
### Full example
```cs
using System;
