 <h1 name="portalfx-localization"></h1>
...
The [Azure Portal Globalization API Formatters](#portalfx-globalization) enables you to easily format numbers, currencies, and dates for different cultures in JavaScript.
...
Packages submitted to the Azure Marketplace must be localized as well.  For more information, read [localization in the gallery](#gallery-items).
...
<a href="https://microsoft.sharepoint.com/teams/WAG/EngSys/Implement/OneBranch/Localization.aspx?a=1">Azure Engineering - Localization in Corext based on Mlp and LBA</a>
 ...
 <h1 name="portalfx-globalization"></h1>
