...
<a name="resiliency-and-failover-how-it-works"></a>
#### How it works
...
<a name="resiliency-and-failover-onboarding"></a>
### Onboarding
...
<a name="resiliency-and-failover-extract-deployment-artifacts-as-part-of-build"></a>
### Extract deployment artifacts as part of build

<a name="resiliency-and-failover-extract-deployment-artifacts-as-part-of-build-content-unbundler"></a>
#### Content Unbundler
...
<a name="resiliency-and-failover-extract-deployment-artifacts-as-part-of-build-build-configuration"></a>
#### Build configuration
...
<a name="resiliency-and-failover-extract-deployment-artifacts-as-part-of-build-isdevelopmentmode"></a>
#### IsDevelopmentMode
...
<a name="resiliency-and-failover-extract-deployment-artifacts-as-part-of-build-environment-specific-configuration-files"></a>
...
<a name="resiliency-and-failover-extract-deployment-artifacts-as-part-of-build-speeding-up-dev-test-cycles-optional"></a>
...
<a name="resiliency-and-failover-running-and-testing-the-extension"></a>
### Running and Testing the extension
<a name="resiliency-and-failover-running-and-testing-the-extension-deploying-an-extension-s-version-zip"></a>
...
<a name="resiliency-and-failover-config-json"></a>
### Config.json
...
<a name="resiliency-and-failover-how-deployment-using-stages-work"></a>
...
<a name="resiliency-and-failover-config-json-properties"></a>
### Config.json Properties:

Property names in the Config.json are case sensitive.

<a name="resiliency-and-failover-config-json-properties-version"></a>
#### $version:
